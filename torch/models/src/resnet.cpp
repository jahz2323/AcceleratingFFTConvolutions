...
resnet_model::resnet_model() {
    ...
    identity1 = register_module("Identity1", torch::nn::Conv2d(torch::nn::Conv2dOptions(64, 128, 1).stride(2)));
    ...
    identity2 = register_module("Identity2", torch::nn::Conv2d(torch::nn::Conv2dOptions(128, 256, 1).stride(2)));
    ...
    identity3 = register_module("Identity3", torch::nn::Conv2d(torch::nn::Conv2dOptions(256, 512, 1).stride(2)));
    ...
    fc = register_module("FC", torch::nn::Linear(512, 32)); // Keypoint for hands 
}
